...
insert into users (id, full_name, username, email, password, clearence) values (1, 'Aleda Collett', 'acollett0', 'acollett0@blinklist.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (2, 'Carlin Gyrgorwicx', 'cgyrgorwicx1', 'cgyrgorwicx1@freewebs.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', false);
insert into users (id, full_name, username, email, password, clearence) values (3, 'Jone Garry', 'jgarry2', 'jgarry2@smh.com.au', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', false);
insert into users (id, full_name, username, email, password, clearence) values (4, 'Broderick Lonergan', 'blonergan3', 'blonergan3@xrea.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (5, 'Lura Sandison', 'lsandison4', 'lsandison4@devhub.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', false);
insert into users (id, full_name, username, email, password, clearence) values (6, 'Haydon Penreth', 'hpenreth5', 'hpenreth5@discuz.net', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (7, 'Vaclav Rowthorne', 'vrowthorne6', 'vrowthorne6@hud.gov', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (8, 'Sharai Tanton', 'stanton7', 'stanton7@weibo.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (9, 'Devland Yewdale', 'dyewdale8', 'dyewdale8@youtube.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', false);
insert into users (id, full_name, username, email, password, clearence) values (10, 'Lucila Bilston', 'lbilston9', 'lbilston9@ibm.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', false);
insert into users (id, full_name, username, email, password, clearence) values (11, 'Carrissa Zima', 'czimaa', 'czimaa@bluehost.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (12, 'Georgetta Boyce', 'gboyceb', 'gboyceb@nba.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (13, 'Mitzi Feather', 'mfeatherc', 'mfeatherc@washington.edu', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (14, 'Wilbur Tuckerman', 'wtuckermand', 'wtuckermand@yellowpages.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (15, 'Florance Dennison', 'fdennisone', 'fdennisone@blogspot.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', false);
insert into users (id, full_name, username, email, password, clearence) values (16, 'Graeme Ballin', 'gballinf', 'gballinf@t-online.de', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', false);
insert into users (id, full_name, username, email, password, clearence) values (17, 'Andromache Poundsford', 'apoundsfordg', 'apoundsfordg@barnesandnoble.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (18, 'Tiertza Wormleighton', 'twormleightonh', 'twormleightonh@cnbc.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', true);
insert into users (id, full_name, username, email, password, clearence) values (19, 'Gerti Mineghelli', 'gmineghellii', 'gmineghellii@samsung.com', '5094d42c0d2ebe17e40a832c59b2e9da7e2c1d7e', false);
insert into users (id, full_name, username, email, password, clearence) values (20, 'Cosmo Postles', 'cpostlesj', 'cpostlesj@ezinearticles.com', '4b231ca66098db0c9fa0002fa5a8e75fbd326ded', false);
UNLOCK TABLES;
